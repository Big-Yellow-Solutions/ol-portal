...
import RealPage from "@/app/(portal)/templates/page";
import { DevHarness } from "@/app/dev/_harness";

/*
 Click-test harness for templates — the real page and the real providers,
 ...
 Then open /dev/templates. Switch identity with
