  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        data-side={side}
        className={cn(
          /* The side-specific width lives here rather than behind a
             `data-[side=right]:` modifier: tailwind-merge only dedupes classes
             that share a modifier, so a caller's plain `w-full sm:max-w-[520px]`
             silently lost to a modifier-prefixed default and every drawer came
             out 3/4-width, capped at 384px. */
